...
class AgentLogger:
    ...
    def __init__(self, logger: logging.Logger, agent_name: str, session_id: Optional[str] = None):
        self.logger = logger
...
def create_app_logger(log_dir: Optional[Path] = None, level: str = "INFO") -> logging.Logger:
