    ...
    async def execute_research(
        ...
        try:
            ...
            input_content = types.Content(
                role="user",
                parts=[types.Part(text=f"Activate Research Swarm. Topic: {topic}. Deploy all agents.")]
            )
            
            # Track agent execution
            agent_exec = self.session_manager.add_agent_execution(session_id, "lead_investigator")
