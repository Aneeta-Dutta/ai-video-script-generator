...
class ProductionOrchestrator:
    ...
    async def execute_production(
        ...
        self.logger.info(f"Starting production for concept: {scene_concept[:100]}...", session_id=session_id)
        ...
        try:
            ...
            agent_exec = self.session_manager.add_agent_execution(session_id, "executive_producer")
