...
from backend.agents.research_agents.grassroots_voice import MANIFEST as GRASSROOTS_MANIFEST  
...
from backend.agents.research_agents.narrative_architect import MANIFEST as NARRATIVE_MANIFEST

from backend.agents.research_agents.data_miner.prompts import construct_instruction as data_miner_instruction
from backend.agents.research_agents.grassroots_voice.prompts import construct_instruction as grassroots_instruction
from backend.agents.research_agents.historian.prompts import construct_instruction as historian_instruction
from backend.agents.research_agents.trend_scout.prompts import construct_instruction as trend_scout_instruction
from backend.agents.research_agents.narrative_architect.prompts import construct_instruction as narrative_instruction
