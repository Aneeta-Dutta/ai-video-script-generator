...
from backend.agents.production_agents.director.prompts import construct_instruction as director_instruction
from backend.agents.production_agents.designer.prompts import construct_instruction as designer_instruction
from backend.agents.production_agents.dop.prompts import construct_instruction as dop_instruction
from backend.agents.production_agents.colorist.prompts import construct_instruction as colorist_instruction
from backend.agents.production_agents.writer.prompts import construct_instruction as writer_instruction
